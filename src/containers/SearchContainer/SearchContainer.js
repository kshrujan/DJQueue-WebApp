...
class SearchContainer extends Component {
    ...
    onEnter = (event) => {
        if(event.key === "Enter") {
            ...
            axios.get('https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&q='+query+'&type=video&key=' + key)
                 .then(response => {
    ...
    render() {
        ...
        return (
            ...
            <div style={visibleStyle}>
                ...
                <YoutubeSearchList navHome={this.props.navHome} data={this.state.youtubeResults} loading={this.state.isLoadingYoutubeResults} clearSearch={this.clearSearch}/>
            </div>
